...
constructor(private prisma: PrismaService,
    ...
    getTeamById(id: number) {
        return this.prisma.handleDbOperation(this.prisma.team.findUnique({
            where: {
                teamId: id
            }
        }));
    ...
    async updateTeam(id: number, data: UpdateTeamDto): Promise<Team> {
        await this.sport.getSportById(data.SportId);
        return this.prisma.handleDbOperation(this.prisma.team.update({
            where: {
                teamId: id
            },
            data
    ...
    deleteTeam(id: number) {
        return this.prisma.handleDbOperation(this.prisma.team.delete({
            where: {
                teamId: id
            }
        }));
